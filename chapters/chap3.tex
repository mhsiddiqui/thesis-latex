...
\begin{itemize}
  ...
  \item{\textbf{Token}:} Token mean each word in a sentence separated by some language specific separator.
  ...
  \item{\textbf{Segment}:} Segment is consists of list of phones.
