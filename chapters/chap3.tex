...
Text to speech synthesis convert raw text into speech waveform. This process 
Text to Speech synthesis system designed in this paper is divided in two sub modules. One module performs analysis and preprocessing of data and other transforms processed data into sound signals. These modules are following
