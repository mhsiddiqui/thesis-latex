...
such as small vocabulary, medium vocabulary, large vocabulary, very large vocabulary and outof-vocabulary.
...
In Formant Synthesis, simple model of speech production and set of rulesuse are used to generate
...
That’s why the derived synthetic speech may not resemble the donor speaker in training database \cite{huang1997recent}.
